...
switch(_shop) do
{
	...
	case "adac_basic":
	{
		switch (true) do 
		{
			case (playerSide != independent): {"You are not ADAC"};
			case (__GETC__(life_mediclevel) < 2): {"You can only as ADAC here access!"}; 
			default {
				["ADAC Shop",
					[
						["ItemGPS",nil,10],
	...
	case "med_basic":
	{
		switch (true) do 
		{
			...
			case (__GETC__(life_mediclevel) < 1): {"You can only as a MEDIC here access!"}; 
			default {
				["Hospital EMS Shop",
					[
						["ItemGPS",nil,10],
	...
	case "cop_patrol":
	{
		...
		{
			case (playerSide !=west): {"You're not a cop"};
			case (__GETC__(life_coplevel) < 2): {"You're not a Constable"};
			default
			{
				["Constable Shop",
					[
						["arifle_sdar_F","Taser Assault Rifle",10],
	...
	case "cop_sergeant":
	{
		...
		{
			case (playerSide !=west): {"You're not a cop"};
			case (__GETC__(life_coplevel) < 3): {"You're not a Seargeant"};
			default
			{
				["Seargeant Shop",
					[
	...
	case "cop_kommisar":
	{
		...
		{
			case (playerSide !=west): {"You're not a cop"};
			case (__GETC__(life_coplevel) < 4): {"You're not a Inspector"};
			default
			{
				["Inspector  Shop",
					[
	...
	case "cop_sek":
	{
		...
		{
			case (playerSide !=west): {"You're not a cop"};
			case (__GETC__(life_coplevel) < 5): {"You're not a Chief Inspector"};
			default
			{
				["Chief Inspector Shop",
					[
	...
	case "cop_gsg":
	{
		...
		{
			case (playerSide !=west): {"You're not a cop"};
			case (__GETC__(life_coplevel) < 6): {"You're not a Superintendent"};
			default
			{
				["Superintendent Shop",
					[
